...
interface IUnusedCreditsEmailProps {
  userName?: string;
...
export function UnusedCreditsEmail({
  userName = 'there',
  creditsRemaining,
  ctaUrl,
  preferenceUrl,
...
}: IUnusedCreditsEmailProps): React.JSX.Element {
  return (
    <Html>
      <Head />
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={content}>
            <Text style={heading}>You still have credits waiting</Text>
            <Text style={paragraph}>Hi {userName},</Text>
            <Text style={paragraph}>
              {creditsRemaining
                ? `${creditsRemaining} credits are ready in your account.`
                : 'Your credits are ready in your account.'}
            </Text>
            <Text style={paragraph}>
              Use them on a new image, a sharper version, or a batch workflow.
            </Text>
