...
// Note: delayChildren removed so badge/intro/CTA animate in immediately after paint.
// H1 is rendered outside this container so it is never hidden by framer-motion (LCP fix).
  ...
  return (
    <section className="pt-12 pb-16 md:pt-16 md:pb-20 relative hero-gradient-2025 z-20">
      ...
      <div className="text-center max-w-6xl mx-auto relative z-10 px-4">
        {/* H1 renders immediately — NOT wrapped in framer-motion so it is never opacity:0.
            This is the LCP element on pSEO pages. Keeping it outside the motion container
            ensures the browser can paint it without waiting for JS animation setup. */}
        ...
        {/* Badge, intro and CTA animate in after initial paint */}
        <motion.div
