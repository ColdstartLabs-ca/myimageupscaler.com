...
const EXTENSIONS: IExtensionCard[] = [
  {
    ...
    description:
      'Upscale images from any webpage with AI-powered right-click upscaling. Drag & drop or context menu integration.',
  ...
  },
  {
    ...
    name: 'Edge Extension',
    description:
      'AI image upscaling for Microsoft Edge. Right-click integration and drag & drop support.',
...
export default function ExtensionsPage() {
  return (
    <>
      <SeoMetaTags path="/extensions" locale="en" />
      <HreflangLinks path="/extensions" category="extensions" locale="en" />
        ...
        <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <div className="mb-12 text-center">
            ...
            <p className="mx-auto max-w-2xl text-lg text-gray-600">
              Install our AI-powered image upscaling extensions and enhance images directly from
              your browser. Right-click on any image to upscale it instantly.
            </p>
          </div>
            ...
            <div className="grid gap-6 md:grid-cols-3">
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Right-click any image on the web and upscale it instantly without leaving your
                  browser.
                </p>
              </div>
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Simply drag and drop images into the extension popup to upscale with your
                  preferred settings.
                </p>
              </div>
              <div>
                ...
                <p className="text-sm text-gray-600">
                  View before/after comparisons in the side panel before downloading your upscaled
                  images.
                </p>
              </div>
            </div>
