...
import { filterEligibleSitemapEntries as filterPseoSitemapEntries } from '@/lib/seo/page-eligibility';
...
export async function GET() {
  ...
  const eligibleAiFeatures = filterPseoSitemapEntries(
    aiFeatures,
    CATEGORY,
    'en',
    feature => `/ai-features/${feature.slug}`,
    feature => feature.lastUpdated
  );
