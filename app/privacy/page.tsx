  ...
  return (
    <main className="flex-1">
      <div className="container mx-auto py-16 px-6 max-w-4xl">
        ...
        <p className="text-base-content/70 mb-8">Last updated: {lastUpdated}</p>
        ...
        <div className="prose prose-slate max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-base-content/80 mb-4">When you create an account, we collect:</p>
            <ul className="list-disc pl-6 mb-4 text-base-content/80">
              <li>Email address</li>
            ...
            <p className="text-base-content/80 mb-4">We automatically collect:</p>
            <ul className="list-disc pl-6 mb-4 text-base-content/80">
              <li>IP address</li>
          ...
          <section className="mb-8">
            ...
            <p className="text-base-content/80 mb-4">We use the collected information to:</p>
            <ul className="list-disc pl-6 mb-4 text-base-content/80">
          ...
          <section className="mb-8">
            ...
            <p className="text-base-content/80 mb-4">We use cookies and similar technologies to:</p>
            <ul className="list-disc pl-6 mb-4 text-base-content/80">
