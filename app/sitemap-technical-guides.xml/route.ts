/**
 * Technical Guides Sitemap Route
 * English-only category
 */

import { NextResponse } from 'next/server';
import { getAllTechnicalGuidesPages } from '@/lib/seo/data-loader';
...
${generateSitemapHreflangLinks(`/technical-guides/${page.slug}`, CATEGORY).join('\n')}
  </url>`
  )
  .join('\n')}
</urlset>`;
