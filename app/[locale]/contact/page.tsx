...
export async function generateMetadata({ params }: IContactPageProps): Promise<Metadata> {
  ...
  return {
    ...
    description:
      ...
      clientEnv.APP_NAME +
      ' team for support, feedback, or questions about our AI image upscaling and enhancement tools.',
    openGraph: {
      title: 'Contact ' + clientEnv.APP_NAME,
      description:
        'Get support, share feedback, or ask questions about our AI-powered image enhancement tools.',
      type: 'website',
      url: canonicalUrl,
