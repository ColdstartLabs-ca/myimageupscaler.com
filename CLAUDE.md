...
- **Conversion Copy Is Load-Bearing**: The free-offer framing ("N free credits", "Free to start", "No credit card required", "Fix My Images Free") stays wherever the regional grant is > 0 — removing it in the 2026-09-10 "Product Truth" pass cut signups ~40%. Guarded by `tests/unit/seo/free-offer-conversion-copy.unit.spec.ts` and `tests/unit/seo/protected-pages.unit.spec.ts` (the pages/terms carrying most organic clicks and signups); accuracy fixes must reword, not delete, the offer. Hero/CTA/title/H1 edits on pages with >100 clicks/28d ship one at a time, each with a `seo-changes-backlog.md` entry and a 7-day signups/clicks readback — never as a bulk rewrite across many files in one deploy.
