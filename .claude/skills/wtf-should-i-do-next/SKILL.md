...
All production secrets live in GCloud Secret Manager, **not** in local `.env.*` (local files hold test/placeholder values). See [gcloud-secrets](../gcloud-secrets/SKILL.md).
