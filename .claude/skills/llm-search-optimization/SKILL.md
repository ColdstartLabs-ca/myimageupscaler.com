...
7-8. Easy language / Fluency — Mixed/marginal results
9. **Keyword Stuffing — PERFORMS 10% WORSE THAN BASELINE**
...
<p>According to [Source], AI upscalers achieve [specific number], compared to [baseline] — a [percentage] improvement. In [study], [statistic with source].</p>
```
