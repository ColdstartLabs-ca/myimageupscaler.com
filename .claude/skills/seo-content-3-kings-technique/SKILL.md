...
> **Before starting:** Read recent SEO/blog changes — `tail -60 .claude/skills/blog-changelog.md` and skim `docs/SEO/maintenance/seo-changes-backlog.md` to avoid rewriting pages that were just refreshed.
