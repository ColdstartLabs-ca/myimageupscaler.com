        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm font-medium">
              <li>
                <Link href={localizedPath('/about')} className="hover:text-accent transition-colors">
                  About
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm font-medium">
              <li>
                <Link href={localizedPath('/contact')} className="hover:text-accent transition-colors">
                  Contact Us
                </Link>
              </li>
              <li>
