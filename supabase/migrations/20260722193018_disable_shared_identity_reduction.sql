-- Roll back the Jul 18 shared-identity credit reduction while preserving its
-- salted-hash telemetry. Based on the ambiguity-fixed live function from
-- 20260718195105; only the grant policy changes.
