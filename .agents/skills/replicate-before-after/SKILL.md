...
```bash
# Basic usage
npx tsx .Codex/skills/replicate-before-after/scripts/scrape-replicate-examples.ts <replicate-url> <tier-slug> [example-index]

# Examples
npx tsx .Codex/skills/replicate-before-after/scripts/scrape-replicate-examples.ts https://replicate.com/xinntao/gfpgan face-restore
npx tsx .Codex/skills/replicate-before-after/scripts/scrape-replicate-examples.ts https://replicate.com/nightmareai/real-esrgan quick 0
npx tsx .Codex/skills/replicate-before-after/scripts/scrape-replicate-examples.ts https://replicate.com/philz1337x/clarity-upscaler hd-upscale 2
```
...
npx tsx .Codex/skills/replicate-before-after/scripts/scrape-replicate-examples.ts https://replicate.com/nightmareai/real-esrgan quick
npx tsx .Codex/skills/replicate-before-after/scripts/scrape-replicate-examples.ts https://replicate.com/xinntao/gfpgan face-restore
npx tsx .Codex/skills/replicate-before-after/scripts/scrape-replicate-examples.ts https://replicate.com/prunaai/p-image-edit fast-edit
npx tsx .Codex/skills/replicate-before-after/scripts/scrape-replicate-examples.ts https://replicate.com/qwen/qwen-image-edit-2511 budget-edit
npx tsx .Codex/skills/replicate-before-after/scripts/scrape-replicate-examples.ts https://replicate.com/bytedance/seedream-4.5 seedream-edit
npx tsx .Codex/skills/replicate-before-after/scripts/scrape-replicate-examples.ts https://replicate.com/xinntao/realesrgan anime-upscale
npx tsx .Codex/skills/replicate-before-after/scripts/scrape-replicate-examples.ts https://replicate.com/philz1337x/clarity-upscaler hd-upscale
npx tsx .Codex/skills/replicate-before-after/scripts/scrape-replicate-examples.ts https://replicate.com/black-forest-labs/flux-2-pro face-pro
npx tsx .Codex/skills/replicate-before-after/scripts/scrape-replicate-examples.ts https://replicate.com/google/nano-banana-2 ultra
```
