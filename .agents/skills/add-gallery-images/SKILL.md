...
```bash
.Codex/skills/add-gallery-images/scripts/add-gallery-images.sh <tier-slug> <before-image> <after-image> [--object-position "center 25%"]
```
...
```bash
bash .Codex/skills/add-gallery-images/scripts/add-gallery-images.sh \
  budget-old-photo \
...
| `.Codex/skills/replicate-before-after/`                     | Alternative: scrape images from Replicate model pages   |
