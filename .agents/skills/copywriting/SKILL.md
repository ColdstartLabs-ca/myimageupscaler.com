...
**Check recent blog changes:** `tail -60 .Codex/skills/blog-changelog.md` — avoid rewriting copy that was recently changed and know the current messaging direction.
