...
prompt: |
  ...
  Run this command:
  node ./.Codex/skills/gsc-analysis/scripts/gsc-fetch.cjs --site=myimageupscaler.com --days=<DAYS> --output=/tmp/gsc-miu.json 2>&1
...
prompt: |
  ...
  Run this command:
  node ./.Codex/skills/ga-analysis/scripts/ga-fetch.cjs --site=myimageupscaler.com --days=<DAYS> --output=/tmp/ga-miu.json 2>&1
...
1. **Check GSC result** - If GSC failed, STOP and display the error. Help the user troubleshoot:
   ...
   - Check script: `node ./.Codex/skills/gsc-analysis/scripts/gsc-fetch.cjs --help`
