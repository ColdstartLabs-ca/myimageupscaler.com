...
1. Read the skill file: .Codex/skills/unit-testing/SKILL.md
...
1. Read the skill file: .Codex/skills/api-testing/SKILL.md
...
1. Read the skill file: .Codex/skills/e2e-testing/SKILL.md
...
- `.Codex/skills/unit-testing/SKILL.md` - Unit test patterns
- `.Codex/skills/api-testing/SKILL.md` - API test patterns
- `.Codex/skills/e2e-testing/SKILL.md` - E2E test patterns
- `.Codex/skills/test-fixing/SKILL.md` - Debugging failing tests
