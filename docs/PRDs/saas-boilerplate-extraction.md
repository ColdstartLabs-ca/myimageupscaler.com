...
- [ ] `react-markdown` - May keep for help pages
- [ ] `remark-gfm` - GitHub flavored markdown
- [ ] `jszip` - May keep if zip download kept
...
- **Directories:** ~35+
- **Files:** ~350+
- **Translation files:** ~1.5MB of JSON (from 2MB to ~50KB)
- **Sitemap files:** ~47 XML files
- **pSEO data files:** 28 JSON files
- **Blog content:** 18 MDX files + compiled JSON
...
| Client Components | 22 dirs | ~15 dirs |
| Translation Files | 48      | ~14      |
| Sitemap Files     | 47      | 2        |
| E2E Tests         | 15+     | ~8       |
| Dependencies      | ~45     | ~35      |
