# MyImageUpscaler - Codex Instructions

## Before Starting

Check `.Codex/skills/` for relevant patterns.

For SEO-facing tasks, use `.Codex/skills/seo-changes-backlog/` and skim `docs/SEO/maintenance/seo-changes-backlog.md` before making changes.
...
- Whenever you feel you learned a new "skill" for this codebase, feel free to add it to `.Codex/skills/`.
